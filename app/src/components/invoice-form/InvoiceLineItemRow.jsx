...
export default function InvoiceLineItemRow({
  ...
  return (
    <div className="group relative bg-white border border-transparent hover:border-border hover:shadow-soft rounded-lg transition-all p-1 -mx-1">
        ...
        <div className="col-span-3 md:col-span-3 flex items-center gap-2">
          {item.tax ? (
            <button
              ...
              className="flex-1 bg-green-50 hover:bg-green-100 text-green-700 text-xs font-medium py-1.5 px-3 rounded border border-green-200/50 transition-colors truncate"
            ...
            <button
              onClick={() => onTaxClick?.(index)}
              className="flex-1 bg-yellow-50 hover:bg-yellow-100 text-yellow-700 text-xs font-medium py-1.5 px-3 rounded border border-yellow-200/50 transition-colors"
            >
              + Tax
            </button>
          )}
